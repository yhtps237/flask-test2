...
$(document).ready(function () {
  ...
  $("#toast-login-error").on("click", function () {
    toastr.error("Daxil edilən məllumatlar yalnışdır !", "Xəta", {
      showMethod: "fadeIn",
      hideMethod: "fadeOut",
      timeOut: 2e3
    });
    }), 
  $("#toast-code-error").on("click", function () {
    toastr.error("Təhlükəsizlik kodunu düzgün daxil edin !", "Xəta", {
      showMethod: "fadeIn",
      hideMethod: "fadeOut",
      timeOut: 2e3
    });
     }), 
  $("#toast-mail-error").on("click", function () {
    toastr.error("E-poçt ünvanı tapılmadı !", "Xəta", {
      showMethod: "fadeIn",
      hideMethod: "fadeOut",
      timeOut: 2e3
    });
