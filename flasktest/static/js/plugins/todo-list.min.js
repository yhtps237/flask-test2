$(document).ready(function() {
    ...
    var n = [{
            id: 1,
            img: "../../dist-assets/images/faces/1.jpg"
        }, {
            id: 2,
            img: "../../dist-assets/images/faces/2.jpg"
        }, {
            id: 3,
            img: "../../dist-assets/images/faces/3.jpg"
        }, {
            id: 4,
            img: "../../dist-assets/images/faces/4.jpg"
        }],
        t = [{
            id: 1,
            title: "Bob",
    ...
    $("#todo-list-search").keyup(function() {
        ...
        e = $(this).val(), $("#userTable li").each(function() {
            var a = "false";
            $(this).each(function() {
                $(this).text().toLowerCase().indexOf(e.toLowerCase()) >= 0 && (a = "true"), "true" == a ? $(this).show() : $(this).hide()
            })
        })
        ...
        var e, a = {},
            ...
            l = n.filter(e => e.id == d);
        s && o && 0 != d ? ($(this).serializeArray().map(function(e) {
            a[e.name] = e.value, a = {
                ...a,
                ...l[0]
            }
        }), console.log(a), e = a, t.push(e), i(e), this.reset()) : alert("All fields must have a valid value.")
    })
});